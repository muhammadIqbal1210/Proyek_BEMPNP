    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Filter Form -->
                    <form method="GET" action="<?= base_url('member/beasiswa') ?>" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($status == 'pending'): ?>
                                                    <a href="<?= base_url('member/beasiswa/edit/' . $pengajuan['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="<?= base_url('member/beasiswa/delete/' . $pengajuan['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus pengajuan ini?')">Hapus</a>
                                                <?php else: ?>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center">Tidak ada pengajuan beasiswa.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
