    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= base_url('member/event/create') ?>" class="btn btn-primary mb-3">Ajukan Event Baru</a>
                    
                    <!-- Filter Form -->
                    <form method="GET" action="<?= base_url('member/event') ?>" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($status == 'pending'): ?>
                                                    <a href="<?= base_url('member/event/edit/' . $pengajuan['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="<?= base_url('member/event/delete/' . $pengajuan['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus pengajuan ini?')">Hapus</a>
                                                <?php else: ?>
