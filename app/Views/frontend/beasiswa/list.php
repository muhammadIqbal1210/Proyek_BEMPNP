...
<main class="max-w-6xl mx-auto px-6 py-12">
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-3/4">
            ...
            <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-6" data-aos="zoom-in" data-aos-delay="200">
                ...
                <a href="<?= base_url('beasiswa/detail/' . $beasiswa['id']) ?>"
                    ...
                    <div class="relative h-48 bg-gray-50 overflow-hidden">
                        <div class="absolute top-3 left-3 z-10">
                            <span
                                class="<?= $status_badge_class ?> text-[10px] font-bold px-3 py-1 rounded-full uppercase">
                                <?= $status_text ?>
                            </span>
                        </div>
                    ...
                    <div class="p-6">
                        <h3
                            class="font-bold text-lg text-gray-900 group-hover:text-green-700 transition-colors line-clamp-2 mb-2">
