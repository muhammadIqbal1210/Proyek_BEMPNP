...
<header class="pt-24 pb-16 bg-white mb-24">
    <div class="max-w-6xl mx-auto px-6 text-center">
        <p class="text-orange-500 font-bold text-l max-w-2xl mx-auto" data-aos="fade-down">
        ...
        <p class="text-gray-500 text-lg max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="400">
            Hubungi Kontak Penting BEM KM Politeknik Negeri Padang untuk berbagai keperluan informasi dan layanan
            mahasiswa.
        </p>
    </div>
</header>
...
<main class="max-w-6xl mx-auto px-6 pb-24">
    ...
    <!-- Bagian Internal BEM -->
    <div class="mb-16">
        <div class="max-w-6xl mx-auto pb-12 text-center" data-aos="fade-up">
...
<div class="bg-white p-10 rounded-[1.5rem] shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-all duration-300 min-h-full"
    ...
    <div class="space-y-4">
        ...
        <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $k['whatsApp']) ?>" target="_blank"
        ...
        <a href="<?= esc($k['website']) ?>" target="_blank" class="flex items-center group">
            <i
                class="fa-solid fa-arrow-up-right-from-square text-slate-700 w-6 group-hover:text-green-700 transition-colors text-xs"></i>
