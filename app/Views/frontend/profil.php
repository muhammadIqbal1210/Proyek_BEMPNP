...
<header class="pt-16 pb-12 mb-5 ">
    <div class="max-w-6xl mx-auto px-6 text-center">
        <h1 class="text-4xl font-extrabold text-black mb-2 pb-2 border-b-4 border-orange-400 inline-block ">Profil Organisasi</h1>
        <p class="text-black-200 text-lg">Profil Badan Eksekutif Mahasiswa KM
